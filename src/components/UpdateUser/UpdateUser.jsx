...
import Input from "../commonComponents/InputAdi";
import UpdateButton from "../commonComponents/UpdateButton";
...
export default function UpdateUser({ onClose, theme }) {
  const { user } = useAuth();
